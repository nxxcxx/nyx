...
function setup( $ ) {
	...
	// canvas in new window
	var extWin = window.open( '', '', 'width=500,height=500,scrollbars=no,location=no,status=no,menubar=no,resizable=no' )
	extWin.document.body.appendChild( $.renderer.canvas )
